...
export async function cleanupNuxtDirs(rootDir) {
...
export function nuxtVersionToGitIdentifier(version) {
...
export function resolveNuxtManifest(nuxt) {
    const manifest = {
        _hash: null,
        project: {
...
export async function writeNuxtManifest(nuxt) {
...
export async function loadNuxtManifest(buildDir) {
